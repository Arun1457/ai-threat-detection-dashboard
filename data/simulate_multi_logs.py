...
iot_data.to_csv("C:\\study material\\major_project\\data\\iot_logs.csv", index=False)
...
network_data.to_csv("C:\\study material\\major_project\\data\\network_logs.csv", index=False)
...
cloud_data.to_csv("C:\\study material\\major_project\\data\\cloud_logs.csv", index=False)
